...
public partial class LevelSystem : MonoBehaviour
{
  ...
  NativeHashMap<int, ShapeQuadData> _blockShapeDatas;
  ...
  void InitDataBuffers(LevelInformation levelInformation)
  {
    ...
    _blockShapeDatas = new NativeHashMap<int, ShapeQuadData>(blockGrid.GridSize.x * blockGrid.GridSize.y / 4, Allocator.Persistent);
