		...
		protected virtual void GenerateLayer(MMTilemapGeneratorLayer layer)
		{
			...
			switch (layer.GenerateMethod)
			{
				...
				case GenerateMethods.RandomWalkAvoider:
					...
					int[,] groupPassengerGrid = MMGridGenerator.TilemapToGrid(layer.RandomWalkAvoiderObstaclesTilemap, width, height);
					_grid = MMGridGeneratorRandomWalkAvoider.Generate(width, height, seed, layer.RandomWalkAvoiderPercent, layer.RandomWalkAvoiderStartingPoint, groupPassengerGrid, layer.RandomWalkAvoiderObstaclesDistance, layer.RandomWalkAvoiderMaxIterations);
					layer.Grid = _grid;
					break;
